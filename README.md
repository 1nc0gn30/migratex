...
X is phasing out Communities, but your people arent going anywhere. Use MigrateX to keep your network together.
...
### 📦 Installation
```bash
git clone https://github.com/1nc0gn30/migratex.git
cd migratex
npm install
```
...
View your app in AI Studio: https://ai.studio/apps/2ecc50d2-e577-4ca7-978f-31f41a0494a2
...
## 🔗 Links
- GitHub: https://github.com/1nc0gn30/migratex
